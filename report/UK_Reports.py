...
report_sxw.report_sxw(
	...
	'sale.order', 
    'addons/UK_Reports/report/UK_sale_print_order.rml', 
...
report_sxw.report_sxw(
    ...
    'account.invoice',
    'addons/UK_Reports/report/UK_account_print_invoice.rml',
...
report_sxw.report_sxw(
    ...
    'res.partner',
    'addons/UK_Reports/report/UK_account_print_overdue.rml', 
    parser=Overdue
)
